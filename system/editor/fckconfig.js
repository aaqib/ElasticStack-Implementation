...
FCKConfig.ToolbarSets['Default'] = [
	['Undo','Redo','-','Find','Replace','SelectAll','-','JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyFull'],
	['StyleSimple','FontFormatSimple','FontNameSimple','FontSizeSimple'],'/',
	['OrderedList','UnorderedList','SpecialChar','-','Bold','Italic','Underline','StrikeThrough'],
