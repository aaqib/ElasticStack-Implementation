...
?>
	...
	<td class="inr-tabrow3"><?=$result['gateway'];?></td>
	<td class="inr-tabrow3"><?=$result['netmask'];?></td>
	<td class="inr-tabrow4"><a class="inr-tablnk1" href="eh_ip_add_edit.php?id=<?=$row[0]?>">Edit Details</a></td>
	</tr>
<?php 
}
?>
