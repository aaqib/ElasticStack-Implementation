...
<body onload="javascript:getData('ajax_content/eh_ip.php','?sort=0&path=ajax_content/eh_ip.php&limit=<?=REC;?>&page=<?=$page;?>&order=desc', 'results');">
...
<h1>Elastic Hosts Static IPs</h1><a class="inv_addlnk" href="eh_ip_add_edit.php">Create New Static IP</a></div>
