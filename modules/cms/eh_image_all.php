...
<body onload="javascript:getData('ajax_content/eh_image.php','?sort=0&path=ajax_content/eh_image.php&limit=<?=REC;?>&page=<?=$page;?>&order=desc', 'results');">
...
<h1>Elastic Hosts Images</h1><a class="inv_addlnk" href="eh_image_add_edit.php">Add New Image</a></div>
