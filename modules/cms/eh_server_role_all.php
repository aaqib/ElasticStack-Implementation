...
<body onload="javascript:getData('ajax_content/eh_server_role.php','?sort=0&path=ajax_content/eh_server_role.php&limit=<?=REC;?>&page=<?=$page;?>&order=desc', 'results');">
...
<h1>Elastic Hosts Server Roles</h1><a class="inv_addlnk" href="eh_server_role_add_edit.php">Add New Server Role</a></div>
