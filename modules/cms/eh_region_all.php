...
<body onload="javascript:getData('ajax_content/eh_region.php','?sort=0&path=ajax_content/eh_region.php&limit=<?=REC;?>&page=<?=$page;?>&order=desc', 'results');">
...
<h1>Elastic Hosts Regions</h1><a class="inv_addlnk" href="eh_region_add_edit.php">Add New Region</a></div>
