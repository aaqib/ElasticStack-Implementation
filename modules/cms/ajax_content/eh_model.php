...
$q = "SELECT $str FROM eh_model ORDER BY ".$sort." ".$order;
...
<td class="inr-tabrow4"><a class="inr-tablnk1" href="eh_model_add_edit.php?id=<?=base64_encode($row[0])?>">Edit Details</a></td>
</tr>
