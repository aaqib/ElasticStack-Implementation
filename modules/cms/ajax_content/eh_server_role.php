...
$q = "SELECT $str FROM eh_server_role ORDER BY ".$sort." ".$order;
...
<td class="inr-tabrow4"><a class="inr-tablnk1" href="eh_server_role_add_edit.php?id=<?=base64_encode($row[0])?>">Edit Details</a></td>
</tr>
...
<?php 
$links = getActionLinks('eh_server_role');
$count = count($links);
$i=0;
